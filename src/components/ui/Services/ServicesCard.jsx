    ...
    return (
        <div className='col-12 col-sm-6 col-md-4 col-lg-3 mb-4'>
            <div className="services_card_box">
                <div className="services_card_offer">10% off</div>
                ...
                <div className="services_card_text_box">
                    <Link to='/services/details/123' className="services_card_title">Indeed Candidate Resume Sourcing.</Link>
                    <p className="services_card_description">Lorem, ipsum dolor sit amet consectetur adipisicing elit. A exercitationem facere corporis, iste rem rerum.</p>
                    <div className="d-flex align-items-center justify-content-between border-top pt-2">
                        ...
                        <span className="service_card_rating"><FaStar /> 4.5</span>
                    </div>
                </div>
            </div>
        </div>
